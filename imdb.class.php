 ...
 * @license MIT License
 *
 * @version 5.0.0a (October 8th, 2010)
 *
 * @todo
 * - Add a cURL caching mechanism
 * - ...
*/
...
class IMDB {
     ...
     */
    public function __construct($strSearch, $intCache = 0) {
     ...
     * @return boolean
     */
    private function fetchUrl($strSearch, $intCache = 0) {
        // Remove whitespaces.
        ...
        if (function_exists('curl_init')) {
            ...
            if ($strMatch = $this->matchRegex($strOutput, IMDB::IMDB_REDIRECT, 1)) {
                ...
                IMDB::fetchUrl($strMatch, $intCache);
            }
